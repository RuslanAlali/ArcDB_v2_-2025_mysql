...
class VariantCounts(Base):
    __tablename__ = 'variant_counts_highQC'
...
def process_variants_and_counts():
    ...
    try:
        ...
        for partition_id in unique_partition_ids:
            ...
            # For HighQC, QUAL is set to +50
            count_query = text(
                f"SELECT variantID, COUNT(*) AS count FROM VCF_detection WHERE partitionID = :pid and QUAL>50 GROUP BY variantID"
            )
